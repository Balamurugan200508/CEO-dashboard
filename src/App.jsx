        ...
        return (
          <div className="panel" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
              <button className="btn-primary" onClick={() => setActiveWorkspace({ slide: 1, tab: 'market' })} style={{ padding: '10px 18px', fontSize: '13px' }}>Market Workspace ↗</button>
              <button className="btn-primary" onClick={() => setActiveWorkspace({ slide: 1, tab: 'products' })} style={{ padding: '10px 18px', fontSize: '13px' }}>Products Manager ↗</button>
              <button className="btn-primary" onClick={() => setActiveWorkspace({ slide: 1, tab: 'growth' })} style={{ padding: '10px 18px', fontSize: '13px' }}>Growth Planner ↗</button>
            </div>
